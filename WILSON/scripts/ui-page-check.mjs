...
async function measure(label) {
  ...
  console.log(`${label.padEnd(20)} err=${errors.length}  hOverflow=${info.overflow}  offScale=${info.offScale}   ${sizes}${thin ? '   ! ONLY ' + info.measured + ' TEXT NODES — did this page render?' : ''}`);
