...
function AgentToast({ message, onDone }) {
  return (
    <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-50 bg-stone-800 border border-orange-500 text-orange-400 px-4 py-2 rounded-sm text-dense font-mono shadow-lg animate-fade-in-up"
