            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-4 mb-5">
              ...
              <div>
                ...
                {task.asset_id && !assets.some(a => a.id === task.asset_id) ? (
                  ...
                  <div className="w-full px-2.5 py-1.5 text-dense font-mono rounded"
              ...
              <div>
                ...
                {task.assigned_role_slug && !currentRoleEntry && (
                  <div className="text-dense font-mono mt-0.5" style={{ color: '#fca5a5' }}>
            ...
            <div className="mb-5">
              ...
              {editingDesc ? (
                ...
                <button type="button" onClick={() => { setDescDraft(task.description || ''); setEditingDesc(true) }}
                  className="w-full text-left px-3 py-2 text-dense font-mono rounded hover:bg-stone-700/40 transition-colors min-h-[60px]"
            ...
            <div className="mb-5">
              ...
              {editingNotes ? (
                ...
                <button type="button" onClick={() => { setNotesDraft(task.notes || ''); setEditingNotes(true) }}
                  className="w-full text-left px-3 py-2 text-dense font-mono rounded hover:bg-stone-700/40 transition-colors min-h-[48px]"
    ...
    <div className="mb-2">
      ...
      {editingFileName ? (
        <input autoFocus
          ...
          className="w-full px-2 py-1 text-dense font-mono rounded focus:ring-2 focus:ring-orange-500"
        ...
        <button type="button"
          ...
          className="w-full text-left px-2 py-1 text-dense font-mono rounded hover:bg-stone-700/40 transition-colors truncate"
