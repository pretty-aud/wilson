        ...
        >
          {items.map(item => (
            <button
              ...
              type="button"
              role="menuitem"
              onClick={() => { setOpen(false); btnRef.current?.focus({ preventScroll: true }); item.run?.(course) }}
          ...
          {mayTrash && (
            <>
              ...
              <button
                type="button"
                role="menuitem"
                onClick={() => { setOpen(false); btnRef.current?.focus({ preventScroll: true }); onTrash?.(course) }}
                className="ui-menu-item"
                data-danger="true"
              >
