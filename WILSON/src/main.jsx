...
import { devFixturesActive } from './dev/devFixtures'
...
// .env.local (and the badge not switched off) the fake dataset is loaded
// BEFORE the first render, so that
...
if (import.meta.env.DEV && devFixturesActive()) {
