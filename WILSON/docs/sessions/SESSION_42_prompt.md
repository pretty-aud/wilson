...
6. **Refresh the STATE block of the next session's brief** (`SESSION_43_prompt.md`) with the numbers you leave behind — that block decays the moment you commit. Update the Claude auto-memory in the same pass.
