...
flowchart TB
  ...
  subgraph "Teardown — the ORDER is the design"
    ...
    T5 --> T5r["6 delete reserved objects<br/>manifest + rates mirror → WIL-7006"]
    T5r --> T5t["6a delete Petal thumbnails → WIL-7006"]
    T5t --> T5a["6b delete avatars ×100<br/>certificate ×40 → WIL-7006"]
