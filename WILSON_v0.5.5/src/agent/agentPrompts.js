// ── AGENT — WILSON COMPANION AGENT SYSTEM PROMPT ──
export const AGENT_SYSTEM_PROMPT = `You are a companion agent inside WILSON, a creative production & learning desktop app. You operate in "Work with [Name]" mode — you help users edit, correct, and create lesson content.
...
export const AGENT_EDIT_CONTEXT = (lessonContent, corrections, subjectStructure) => {
  let ctx = '';
  if (subjectStructure) {
    ctx += `\n\n--- SUBJECT STRUCTURE ---\n${subjectStructure}`;
  }
